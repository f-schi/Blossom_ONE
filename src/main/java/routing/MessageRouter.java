...
public abstract class MessageRouter {
	...
	public List<ClusterListener> cListeners;
	 ...
	 */
	public void init(DTNHost host, List<MessageListener> mListeners, List<ClusterListener> cListeners) {
	 ...
	 */
	public int findReachableClusterMembers() {return 0;};
	...
	public String getHostNameWhenItEqualsGivenHashedHostName(String hashedReceiver) {
		return null;
	};
}
