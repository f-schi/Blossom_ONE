...
public class DTNHost implements Comparable<DTNHost> {
	...
	private final double adjustmentParameter = 0.9; //> 0.5 && =< 1
	private Cluster cluster;
	private int reachableClusterMembers;
	...
	public DTNHost(List<MessageListener> msgLs,
		   	List<ClusterListener> clusterListeners,
	...
	private void setRouter(MessageRouter router) {
		router.init(this, msgListeners, clusterListeners);
		this.router = router;
	}
	...
	/**
	 * Gives the public direction of this host.
	 * In case the security layer is enabled, it tries to return the direction of its cluster.
	 * @return public direction.
	 */
	public final Direction getDirection() {
		Direction publicDirection;

		if (getRouter().isCloakingEnabled() && cluster != null && cluster.getAverageDirection() != null) {
			publicDirection = cluster.getAverageDirection();
		} else {
	...
	public void move(double timeIncrement) {
		...
		this.direction.setDirectionFromMovement(dx, dy, getRouter().getAdjustmentParameter());
	}
	...
	public int getReachableClusterMembers() {
		return this.reachableClusterMembers;
	}

	public void setReachableClusterMembers(int reachableClusterMembers) {
		this.reachableClusterMembers = reachableClusterMembers;
	}
